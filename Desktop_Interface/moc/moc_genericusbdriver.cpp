...
QT_MOC_LITERAL(37, 402, 14)
    ...
    "status\0initialConnectComplete\0setPsu\0"
...
void genericUsbDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->initialConnectComplete(); break;
        case 10: _t->setPsu((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 11: _t->setFunctionGen((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< functionGenControl*(*)>(_a[2]))); break;
        case 12: _t->setDeviceMode((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 13: _t->newDig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 14: _t->psuTick(); break;
        case 15: _t->setGain((*reinterpret_cast< double(*)>(_a[1]))); break;
        ...
        {
            typedef void (genericUsbDriver::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&genericUsbDriver::initialConnectComplete)) {
                *result = 9;
            }
        }
    }
