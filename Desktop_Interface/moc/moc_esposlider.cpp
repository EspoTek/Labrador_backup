...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_espoSlider_t, stringdata) + ofs \
...
const QMetaObject espoSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_espoSlider.data,
      qt_meta_data_espoSlider,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_espoSlider.stringdata))
