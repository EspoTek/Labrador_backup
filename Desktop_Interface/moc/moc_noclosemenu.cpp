...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_noCloseMenu_t, stringdata) + ofs \
...
const QMetaObject noCloseMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_noCloseMenu.data,
      qt_meta_data_noCloseMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_noCloseMenu.stringdata))
