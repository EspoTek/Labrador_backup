...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionLo_bw->setObjectName(QStringLiteral("actionLo_bw"));
        actionLo_bw->setCheckable(true);
        actionLo_bw->setChecked(true);
        actionSingle_ep_msync = new QAction(MainWindow);
        actionSingle_ep_msync->setObjectName(QStringLiteral("actionSingle_ep_msync"));
        actionSingle_ep_msync->setCheckable(true);
        actionSingle_ep_async = new QAction(MainWindow);
        actionSingle_ep_async->setObjectName(QStringLiteral("actionSingle_ep_async"));
        ...
        multimeterResistanceSelect->setMaximum(1e+06);
        ...
        frequencyValue_CH1->setMaximum(1e+06);
        ...
        frequencyValue_CH2->setMaximum(1e+06);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionLo_bw->setText(QApplication::translate("MainWindow", "lo-bw", 0));
        actionSingle_ep_msync->setText(QApplication::translate("MainWindow", "single-ep-msync", 0));
        actionSingle_ep_async->setText(QApplication::translate("MainWindow", "single-ep-async", 0));
        ...
        menuConnection_Type->setTitle(QApplication::translate("MainWindow", "Connection Type", 0));
    } // retranslateUi
